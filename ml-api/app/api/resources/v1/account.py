...
def login_access_token(
    ...
    access_token, access_token_expire = token_helper.create_access_token(
        token_create.__dict__
    )
    refresh_token, refresh_token_expire = token_helper.create_fresh_token(
        token_create.__dict__
    )
