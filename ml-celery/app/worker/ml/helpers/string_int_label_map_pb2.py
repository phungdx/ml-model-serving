...
_STRINGINTLABELMAPITEM_KEYPOINTMAP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="object_detection.protos.StringIntLabelMapItem.KeypointMap.id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="label",
            full_name="object_detection.protos.StringIntLabelMapItem.KeypointMap.label",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_STRINGINTLABELMAPITEM = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="keypoints",
            full_name="object_detection.protos.StringIntLabelMapItem.keypoints",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="ancestor_ids",
            full_name="object_detection.protos.StringIntLabelMapItem.ancestor_ids",
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="descendant_ids",
            full_name="object_detection.protos.StringIntLabelMapItem.descendant_ids",
            index=5,
            number=6,
            type=5,
            cpp_type=1,
...
_STRINGINTLABELMAPITEM.fields_by_name[
    "keypoints"
].message_type = _STRINGINTLABELMAPITEM_KEYPOINTMAP
...
StringIntLabelMapItem = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    dict(
        KeypointMap=_reflection.GeneratedProtocolMessageType(
            "KeypointMap",
            (_message.Message,),
            dict(
